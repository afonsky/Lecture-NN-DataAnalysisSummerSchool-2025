...
* Каждый нейрон в правой части представляет собой выход нейронной сети, когда он классифицирует одно местоположение на входном изображении
...
* Синяя (тень) - это $3\times 3$ **ядро** (оно же **фильтр**)
...
* **Stride** $S$ - количество *пикселей*, на которое перемещается окно после каждой операции
* **Zero-padding** $P$ - количество нулей по обе стороны за границами входного сигнала
...
Вы можете использовать *много каналов* на входе. Цветное изображение обычно имеет 3 входных канала: RGB.
